...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...parent,
    alternates: {
      canonical: `https://homepapa.ca/pre-construction-homes/${params.city}/condos/`,
    },
    title: data.preconstructions.length + " Preconstruction Condos in " + city,
    openGraph: {
      images: retImage(data.preconstructions),
    },
    description: `${city} upcoming pre construction Condos. Check out ${data.preconstructions.length}+ new construction condos on Homepapa. Floor plans & pricing updated for upcoming new construction condos in ${city}`,
  };
}
