...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...parent,
    alternates: {
      canonical: `https://homepapa.ca/pre-construction-homes/${params.city}/detached/`,
    },
    title:
    ...
    description: `${city} upcoming pre construction Detached Homes. Check out ${data.preconstructions.length}+ new construction detached homes on Homepapa. Floor plans & pricing updated for upcoming new construction detached homes in ${city}`,
  };
}
