...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...parent,
    alternates: {
      canonical: `https://homepapa.ca/pre-construction-homes/${params.city}/`,
    },
    title: data.preconstructions.length + " Preconstruction Homes in " + city,
    openGraph: {
      images: retImage(data.preconstructions),
    },
    description: `${city} pre construction TownHomes, Detached & Condos. Check out ${data.preconstructions.length}+ new construction homes on Homepapa. Floor plans & pricing updated for new construction homes in ${city}`,
  };
}
