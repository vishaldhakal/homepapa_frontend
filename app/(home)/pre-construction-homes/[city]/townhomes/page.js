...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...parent,
    alternates: {
      canonical: `https://homepapa.ca/pre-construction-homes/${params.city}/townhomes/`,
    },
    title:
    ...
    description: `${city} upcoming pre construction Townhomes. Check out ${data.preconstructions.length}+ new construction townhomes on Homepapa. Floor plans & pricing updated for upcoming new construction townhomes in ${city}`,
  };
}
